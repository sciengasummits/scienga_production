...
const DEFAULTS = {
    pdfUrl: '',
    title: 'International Conference on Food and Agriculture Summit 2026',
    description: 'Download the official conference brochure to get comprehensive information about the International Conference on Food and Agriculture Summit. It serves as your complete guide to the event, featuring detailed schedules, speaker profiles, and venue information.',
...
const Brochure = () => {
    usePageSEO({
        ...
        description: 'Download the official FOODAGRISUMMIT2026 conference brochure – program schedule, keynote speaker profiles, workshop details, venue maps, and sponsorship opportunities.',
        canonical: 'https://foodagrisummit.com/brochure',
    });
                        ...
                        <div className="brochure-preview">
                            <div className="preview-card">
                                <div className="preview-header">
                                    <div className="preview-logo-placeholder">FAS 2026</div>
