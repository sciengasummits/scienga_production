...
const DEFAULTS = {
    ...
    intro: 'The INTERNATIONAL CONFERENCE ON Food and Agriculture Summit welcomes speakers & delegates from all over the world. Below is essential visa-related information to assist with your travel planning.',
    sections: [
        {
            id: 'visa_need',
    ...
    contactEmail: 'food@sciengasummits.com',
...
const VisaInfo = () => {
    usePageSEO({
        ...
        description: 'Visa information for international participants attending FOODAGRISUMMIT2026 in Singapore. Learn about visa requirements, required documents, and how to request an official invitation letter.',
        canonical: 'https://FOODAGRISUMMIT2026.com/visa-info',
    });
                ...
                <div className="container">
                    <div className="visa-content-wrapper">
                        ...
                        {visaData.contactEmail && (
                            <div className="visa-info-block">
                                <p>For visa support or queries, contact us at: <a href={`mailto:${visaData.contactEmail}`} style={{ color: '#34a853', fontWeight: 600 }}>{visaData.contactEmail}</a></p>
                            </div>
                        )}
                    </div>
                </div>
