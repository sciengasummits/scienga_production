    ...
    categories: [
        {
            ...
            items: [
                {
                    question: 'How can I register for the INTERNATIONAL CONFERENCE ON Food and Agriculture Summit?',
...
const FAQ = () => {
    usePageSEO({
        ...
        description: 'Find answers to common questions about FOODAGRISUMMIT2026 – registration, abstract submission, visa & travel, accommodation, and the conference program. Contact us for further help.',
        canonical: 'https://FOODAGRISUMMIT2026.com/faqs',
    });
