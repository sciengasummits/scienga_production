...
const DEFAULT_DATES = [
    ...
    { month: 'NOV', day: '10', year: '2026', event: 'Abstract Submission Deadline', icon: 'Clock' },
    {
        month: 'DEC', day: '14', year: '2026',
        event: 'Conference Date',
        sub: 'December 14–16, 2026, Outram, Singapore',
        icon: 'Star',
    },
];
...
const AbstractSubmission = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // submitAbstract() in siteApi.js automatically adds conference: 'foodagri' (updated via bulk script)
