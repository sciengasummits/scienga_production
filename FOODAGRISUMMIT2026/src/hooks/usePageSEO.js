...
const SITE_NAME = 'FOODAGRISUMMIT2026';
const BASE_URL = 'https://foodagrisummit.com';
const DEFAULT_IMAGE = `${BASE_URL}/og-image.png`;
const DEFAULT_DESC =
  'INTERNATIONAL CONFERENCE ON FOOD AND AGRICULTURE SUMMIT. December 14–16, 2026 · Outram, Singapore.';
    ...
    useEffect(() => {
        const apply = (dbData) => {
            ...
            const fullTitle = rawTitle
                ...
                : `${SITE_NAME} | INTERNATIONAL CONFERENCE ON FOOD AND AGRICULTURE SUMMIT – Singapore`;
