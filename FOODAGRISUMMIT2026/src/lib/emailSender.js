...
export class RealEmailSender {
    constructor() {
        ...
        this._defaultUser = process.env.SMTP_USER || 'food@sciengasummits.com';
        ...
        // Always build a default/fallback transporter (foodagri)
        this._defaultTransporter = this._transporters['foodagri'] || nodemailer.createTransport({
            service: 'gmail',
     ...
     * @param {string} [conferenceId] - Optional: 'foodagri' | 'foodagri' | 'fluid' | 'renewable'
     */
    ...
    async sendOTPEmail(email, otp, username, conferenceId) {
        const htmlContent = `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                <div style="background: linear-gradient(135deg, #34a853, #2e7d32); padding: 30px; border-radius: 10px; text-align: center; margin-bottom: 20px;">
                ...
                <div style="background: #f8fafc; padding: 30px; border-radius: 10px; border: 1px solid #e2e8f0;">
                    ...
                    <div style="background: white; border: 2px solid #34a853; border-radius: 8px; padding: 20px; text-align: center; margin: 20px 0;">
                        <p style="color: #64748b; margin: 0 0 10px 0; font-size: 14px;">Your 6-digit OTP is:</p>
                        <div style="font-size: 32px; font-weight: bold; color: #34a853; letter-spacing: 8px; font-family: monospace;">${otp}</div>
                    </div>
                ...
                <div style="text-align: center; margin-top: 20px; padding: 20px;">
                    <p style="color: #94a3b8; font-size: 12px; margin: 0;">
                        © 2026 FOOD AGRI SUMMIT. All rights reserved.
                    </p>
                </div>
            </div>
        `;
