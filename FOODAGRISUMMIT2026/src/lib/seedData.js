    const foodagriSeedDefaults = [
        ...
        },
        {
            key: 'about',
            data: {
                subtitle: 'Food Security, Agri-Tech & Sustainable Farming',
        ...
        },
        {
            ...
            data: {
                dates: [
                    ...
                    { month: 'DEC', day: '25', year: '2026', event: 'Early Bird Deadline', icon: 'CheckCircle' },
        ...
        },
        {
            ...
            data: {
                sessions: [
                    ...
                    'Agri-Entrepreneurship & Innovation',
    ...
    const foodagriDefaults = [
        ...
        },
        {
            ...
            data: {
                dates: [
                    ...
                    { month: 'DEC', day: '30', year: '2026', event: 'Early Bird Deadline', icon: 'CheckCircle' },
        ...
        },
        {
            ...
            data: {
                ...
                name: 'Outram, Singapore',
                address: 'Singapore',
                description: 'A world-class conference venue in Outram, Singapore, offering state-of-the-art facilities for an international food science and agriculture conference.',
                images: [
                    'https://images.unsplash.com/photo-1540575861501-7ad05823c93e?w=1920&q=80',
                    'https://images.unsplash.com/photo-1512470876302-972fad2aa9dd?w=1920&q=80',
                    'https://images.unsplash.com/photo-1511578314322-379afb476865?w=1920&q=80'
    ...
    const conferences = [
        { name: 'foodagri', defaults: foodagriSeedDefaults },
        { name: 'fluid', defaults: fluidDefaults },
        {
            ...
            defaults: [
                ...
                },
                {
                    ...
                    data: {
                        dates: [
                            { month: 'DEC', day: '01', year: '2026', event: 'Abstract Submission Opens', icon: 'CalendarDays' },
        ...
        },
        {
            ...
            defaults: [
                ...
                },
                {
                    ...
                    data: {
                        dates: [
                            { month: 'DEC', day: '15', year: '2026', event: 'Abstract Submission Opens', icon: 'CalendarDays' },
                ...
                },
                {
                    ...
                    data: {
                        ...
                        name: 'Outram, Singapore',
                        address: 'Singapore',
                        description: 'A world-class conference facility in Outram, Singapore ? a global hub for fintech, cybersecurity, and digital innovation ? offering state-of-the-art facilities and stunning waterfront views.',
                        images: [
                            'https://images.unsplash.com/photo-1540575861501-7ad05823c93e?w=1920&q=80',
                            'https://images.unsplash.com/photo-1512470876302-972fad2aa9dd?w=1920&q=80',
                            'https://images.unsplash.com/photo-1511578314322-379afb476865?w=1920&q=80'
