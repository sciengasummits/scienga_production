...
export async function GET(req) {
  try {
    ...
    const conf = searchParams.get('conference') || 'foodagri';
...
export async function POST(req) {
  try {
    ...
    const { name, email, category, conference = 'foodagri' } = body;
    ...
    const siteUrl = process.env.FRONTEND_URL || 'https://foodagrisummit.com';
