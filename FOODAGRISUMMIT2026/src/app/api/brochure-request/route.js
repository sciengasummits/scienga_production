...
export async function POST(req) {
  try {
    const { name, email, number, conference = 'foodagri' } = await req.json();
    ...
    const adminEmail = account ? account.email : 'food@sciengasummits.com';
    ...
    await emailSender.sendEmail(
      ...
      `<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="text-align: center; margin-top: 20px; padding: 20px;">
          <p style="color: #94a3b8; font-size: 12px; margin: 0;">© 2026 Food Agri Summit. All rights reserved.</p>
        </div>
      </div>`,
      'BROCHURE',
      conference
