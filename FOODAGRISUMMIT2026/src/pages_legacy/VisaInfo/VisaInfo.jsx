...
const DEFAULTS = {
    ...
    intro: 'The INTERNATIONAL CONFERENCE ON FOOD SCIENCE TECHNOLOGY AND AGRICULTURE welcomes speakers & delegates from all over the world. Below is essential visa-related information to assist with your travel planning.',
    sections: [
        {
            id: 'visa_need',
    ...
    contactEmail: 'contact@foodagrisummit.com',
