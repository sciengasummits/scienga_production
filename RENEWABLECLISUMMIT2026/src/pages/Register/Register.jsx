...
const Register = ({ isDiscounted = false }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        const payload = {
            ...
            status: 'Pending',
            conference: 'Renewable Energy Summit 2026'
        };
        ...
        try {
            ...
            const { order } = await siteApi.createPaymentOrder({
                ...
                description: `Renewable Summit Registration: ${formData.fullName}`
            });
            ...
            const options = {
                ...
                name: 'Renewable Energy Summit 2026',
        ...
        <div className="register-page">
            ...
            <div className="container section-padding">
                ...
                <div className="summary-section">
                    ...
                    <p className="processing-fee">Note: {regPricing.processingFeePercent ?? DEFAULTS.processingFeePercent}% of processing charges will be applicable.</p>
