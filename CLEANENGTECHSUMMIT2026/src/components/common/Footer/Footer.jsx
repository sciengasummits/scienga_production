        ...
        <footer className="footer">
            <div className="container">
                <div className="footer__top">
                    ...
                    <div className="footer__col">
                        ...
                        <ul className="footer__contact">
                            ...
                            <li>
                                <Mail size={18} />
                                <span>contact@cleanenergytechsummit.com</span>
                            </li>
                            <li>
                                <Phone size={18} />
                ...
                <div className="footer__bottom">
                    <p>&copy; {new Date().getFullYear()} Global Summit on Clean Energy and Sustainable Technologies. All Rights Reserved.</p>
                </div>
            </div>
        </footer>
    );
