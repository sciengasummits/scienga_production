...
const DEFAULTS = {
    ...
    intro: 'The INTERNATIONAL CONFERENCE ON ADVANCED NANOTECHNOLOGY AND MATERIALS SCIENCE welcomes speakers & delegates from all over the world. Below is essential visa-related information to assist with your travel planning.',
    sections: [
        {
            id: 'visa_need',
    ...
    contactEmail: 'info@advancematerialssummit.com',
