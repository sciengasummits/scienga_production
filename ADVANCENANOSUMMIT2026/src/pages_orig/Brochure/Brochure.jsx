...
const DEFAULTS = {
    pdfUrl: '',
    title: 'International Conference on Advanced Materials And Nanotechnology',
    description: 'Download the official conference brochure to get comprehensive information about the International Conference on Advanced Materials & Nanotechnology. It serves as your complete guide to the event, featuring detailed schedules, speaker profiles, and venue information.',
                        ...
                        <div className="brochure-preview">
                            <div className="preview-card">
                                <div className="preview-header">
                                    <div className="preview-logo-placeholder">ADVANCENANO</div>
