...
const Subscribe = () => {
    usePageSEO({
        title: 'Subscribe',
        description: 'Subscribe to get the latest updates and news from the Advanced Nano Summit 2026.',
                    ...
                    <div className="subscribe-form-wrapper">
                        {success ? (
                            <div className="subscribe-success">
                                ...
                                <p>Thank you for subscribing. You'll receive the latest updates and news from Advanced Nano Summit 2026.</p>
                            ...
                            <>
                                <div className="form-header">
                                    ...
                                    <p>Get the latest news and announcements from Advanced Nano Summit 2026.</p>
                                </div>
