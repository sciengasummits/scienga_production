...
const DEFAULT = {
    subtitle: 'ANNUAL INTERNATIONAL CONFERENCE',
    title: 'PUBLIC HEALTH AND PREVENTIVE MEDICINE',
    description: 'Global Summit on Public Health & Preventive Medicine, where global experts unite to shape the future of healthcare. Discover ground-breaking technologies, connect with top researchers, and explore solutions transforming our world.',
