                    ...
                    <div className="brochure-grid">
                        <div className="brochure-preview">
                            <div className="preview-card">
                                ...
                                <h3 style={{ fontSize: '1.5rem' }}>Annual International Conference on Astronomy, Astrophysics and Space Science</h3>
                        ...
                        <div className="brochure-details">
                            ...
                            <p className="mb-4 text-muted">
                                Download the official conference brochure to get comprehensive information about the Annual International Conference on Astronomy, Astrophysics and Space Science.
