<<<<<<< HEAD:FOODAGRISUMMIT2026 2/src/pages/Register/Register.jsx
...
const DEFAULTS = {
    earlyBirdEndDate: '2026-09-29',
    standardEndDate: '2026-10-30',
    onspotEndDate: '2026-12-07',
    categories: [
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const { order } = await siteApi.createPaymentOrder({
                ...
                description: `Food Agri Summit Registration: ${formData.fullName}`
            });
...
export default Register;
>>>>>>> 2a106ad (message):FOODAGRISUMMIT2026/src/pages/Register/Register.jsx
