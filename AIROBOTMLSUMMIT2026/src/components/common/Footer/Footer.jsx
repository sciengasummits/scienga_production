        ...
        <footer className="footer">
            <div className="container">
                <div className="footer__top">
                    <div className="footer__col">
                        ...
                        <p className="footer__desc">
                            Global experts unite to shape the future of artificial intelligence and intelligent systems.
                            Discover ground-breaking technologies and connect with top AI and robotics professionals.
                        </p>
                ...
                <div className="footer__bottom">
                    <p>&copy; {new Date().getFullYear()} Annual International Conference on AI, Robotics & Machine Learning Summit. All Rights Reserved.</p>
                </div>
            </div>
        </footer>
    );
