...
import DiscountRegister from '../pages/DiscountRegister/DiscountRegister';
        ...
        <>
            ...
            <Routes>
                <Route path="/" element={<Layout />}>
                    ...
                    <Route path="register/onlineregistration" element={<DiscountRegister />} />
                    <Route path="register/discount" element={<DiscountRegister />} />
