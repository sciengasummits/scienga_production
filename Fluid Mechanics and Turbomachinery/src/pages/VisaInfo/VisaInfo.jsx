...
const DEFAULTS = {
    ...
    intro: 'The INTERNATIONAL CONFERENCE ON FLUID MECHANICS & TURBOMACHINERY welcomes speakers & delegates from all over the world. Below is essential visa-related information to assist with your travel planning.',
    sections: [
        {
            id: 'visa_need',
            ...
            points: [
                ...
                'Nationals of many countries (including USA, UK, Canada, Australia, and most EU countries) are eligible for visa-free entry for short-term stays (usually up to 30 or 90 days).',
                'All visitors must submit an SG Arrival Card (SGAC) with Health Declaration via the ICA e-Service within 3 days before arrival in Singapore.',
            ],
        },
        {
            id: 'visa_docs',
    ...
    contactEmail: 'contact@fluidturbosummit.com',
            ...
            <section className="section-padding visa-text-section">
                <div className="container">
                    <div className="visa-content-wrapper">
                        ...
                        {data.note && (
                            <p className="visa-intro-text" style={{ marginTop: '1.5rem', background: 'rgba(0,0,0,0.04)', padding: '1rem', borderRadius: '8px', borderLeft: '4px solid var(--color-primary, #0891b2)' }}>
                        ...
                        {data.contactEmail && (
                            <p className="visa-intro-text" style={{ marginTop: '1rem' }}>
                                ...
                                <a href={`mailto:${data.contactEmail}`} style={{ color: 'var(--color-primary, #0891b2)', fontWeight: 600 }}>
                                    {data.contactEmail}
                                </a>
                            </p>
                        )}
